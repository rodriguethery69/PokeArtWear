...
// Récupérer les tailles de la base de données
$sql = "SELECT * FROM tailles";
$stmt = $db->prepare($sql);
$stmt->execute();
$tailles = $stmt->fetchAll(PDO::FETCH_ASSOC);

// Récupérer les quantités de la base de données
                    ...
                    <div class="swiper-wrapper">
                        <?php foreach ($pokemons as $pokemon) : ?>
                            <div class="swiper-slide img-fluid">
                                <img src="<?= $pokemon['image_path'] ?> " alt="<?php echo $pokemon['nom']; ?>" class="img-fluid">
